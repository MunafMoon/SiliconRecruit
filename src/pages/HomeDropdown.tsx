...
const accordionData: AccordionItemData[] = [
  {
    ...
    content: `
      The BFSI sector (Banking, Financial Services, and Insurance) is a vital economic pillar encompassing banks, investment firms, and insurance providers. We specialize in recruiting top talent for diverse roles across this dynamic and evolving industry, ensuring your organization thrives.</p>
    `,
  },
  {
    id: 2,
    title: 'Healthcare, Pharma, and Lifesciences',
    content: 'This sector encompasses a vast array of organizations dedicated to health, medicine, and biological research. From hospitals and pharmaceutical companies to biotech firms and medical device manufacturers, it\'s a rapidly innovating field focused on improving human well-being. We connect these crucial industries with specialized talent, driving advancements in patient care and scientific discovery.</p>',
      // <ul>
      //     <li>Sub-point 1</li>
      //     <li>Sub-point 2</li>
      // </ul>
  },
  {
    ...
    content: 'The TMT sector is at the forefront of digital transformation, covering telecommunications, digital media, entertainment, and groundbreaking technology development. It\'s a highly dynamic and interconnected industry that shapes how we communicate, consume information, and interact with the world. We specialize in sourcing the innovative minds that power this ever-evolving landscape..</p>',
  },
  {
    id: 4,
    title: 'Energy, Oil, and Gas',
    content: 'This sector is fundamental to global infrastructure, covering the exploration, production, refining, and distribution of energy resources, including traditional oil and gas and renewable energy. It\'s a critical industry facing significant evolution towards sustainable practices. We support these companies by identifying and placing skilled professionals who can navigate complex technical and environmental challenges.</p>',
  },
  // {
  //   id: 5,
  //   title: 'Question 5',
