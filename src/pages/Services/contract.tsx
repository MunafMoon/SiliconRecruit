...
import Ourservices1 from "../../assets/images/Ourservices/ourservice3.png";
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-gray-600 mb-8">
               We bring deep expertise in Contract, temporary, and contract staffing with a sharp focus on results. Whether you're hiring for agility or long-term growth, we deliver the right fit—fast.
              </p>
